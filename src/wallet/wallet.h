...
enum WalletFeature
{
    ...
    FEATURE_HD = 130000,    // Hierarchical key derivation after BIP32 (HD Wallet), BIP44 (multi-coin), BIP39 (mnemonic)
...
public:
    ...
    /// Get 1000COMMERCIUM output and keys which can be used for the Masternode
