...
static CBlock CreateGenesisBlock(const char *pszTimestamp,
                                 ...
                                 const CAmount genesisReward, vuc sol) {
...
//        consensus.nSubsidySlowStopInterval = 1260000; // slow start mining in roughly a month
        ...
        consensus.nMasternodePaymentsStartBlock = 111; // not true, but it's ok as long as it's less then nMasternodePaymentsIncreaseBlock
        consensus.nInstantSendConfirmationsRequired = 6;
        consensus.nInstantSendKeepLock = 24;
        consensus.nBudgetPaymentsStartBlock = 69696969; //DISABLED// actual historical value
        consensus.nBudgetPaymentsCycleBlocks = 87658; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock = 69696969; //DISABLED// The block at which 12.1 goes live (end of final 12.0 budget cycle)
        consensus.nSuperblockCycle = 87658; // ~(60*24*30)/2.6, actual number of blocks per month is 200700 / 12 = 16725
        ...
        // 95% of 2016
        consensus.nRuleChangeActivationThreshold = 38304;
        ...
        consensus.nMinimumChainWork = uint256S("0x0"); //464646
    ...
    // Equihash params
        ...
        // Commercium seeder
/*        vSeeds.push_back(
            CDNSSeedData("commercium.net", "seed.commercium.net", true));*/
...
*/
        vSeeds.push_back(
            CDNSSeedData("testnet.commercium.net", "seed1.testnet.commercium.net", true));
	...
	nFulfilledRequestExpireTime = 60*60; // fulfilled requests expire in 1 hour
        ...
        strSporkAddress = "CSiAkXpRDDzUEr8onSjvxDL3yW3x1L4Wzj";
 ...
 checkpointData = {
        ...
        // Data as of block
        // 000000a4ed99b48466cd46f5164c8bcba26e45b92d71dad133e77219881157fc
        // (height 436969).
...
/*        vSeeds.push_back(CDNSSeedData(
			"commercium.net", "testnet-seed.commercium.net", true));*/
        vSeeds.push_back(
