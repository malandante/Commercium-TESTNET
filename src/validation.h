...
//! Discourage users to set fees higher than this amount (in commercii) per kB
static const CAmount HIGH_TX_FEE_PER_KB = 0.01 * COIN;
//! -maxtxfee will warn if called with a higher fee than this amount (in commercii)
...
static const int64_t DEFAULT_MAX_TIP_AGE = 6 * 60 * 60; // ~144 blocks behind -> 2 x fork detection time, was 24 * 60 * 60 in commercium
...
/** Absolute maximum transaction fee (in commercii) used by wallet and mempool (rejects high fee in sendrawtransaction) */
