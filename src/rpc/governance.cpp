...
//#define ENABLE_COMMERCIUM_DEBUG
...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in commercium.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("commercium.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Commercium features */
    { "commercium",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "commercium",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "commercium",               "gobject",                &gobject,                true,  {} },
    { "commercium",               "voteraw",                &voteraw,                true,  {} },
