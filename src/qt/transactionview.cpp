...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so CommerciumUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(CommerciumUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(CommerciumUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(CommerciumUnits::formatWithUnit(nDisplayUnit, amount, true, CommerciumUnits::separatorAlways));
