...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(), unit(CommerciumUnits::COMMERCIUM),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = CommerciumUnits::floorWithUnit(unit, amount, true, CommerciumUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(CommerciumUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, CommerciumUnits::separatorAlways));
    ui->labelUnconfirmed->setText(CommerciumUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, CommerciumUnits::separatorAlways));
    ui->labelImmature->setText(CommerciumUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, CommerciumUnits::separatorAlways));
    ui->labelAnonymized->setText(CommerciumUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, CommerciumUnits::separatorAlways));
    ui->labelTotal->setText(CommerciumUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, CommerciumUnits::separatorAlways));
    ui->labelWatchAvailable->setText(CommerciumUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, CommerciumUnits::separatorAlways));
    ui->labelWatchPending->setText(CommerciumUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, CommerciumUnits::separatorAlways));
    ui->labelWatchImmature->setText(CommerciumUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, CommerciumUnits::separatorAlways));
    ui->labelWatchTotal->setText(CommerciumUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, CommerciumUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("COMMERCIUM")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = CommerciumUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, CommerciumUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), CommerciumUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = CommerciumUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, CommerciumUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), CommerciumUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(CommerciumUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(CommerciumUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
