...
void MasternodeList::updateMyMasternodeInfo(QString strAlias, QString strAddr, const COutPoint& outpoint)
{
    ...
    QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(fFound ? CCommerciumAddress(infoMn.pubKeyCollateralAddress.GetID()).ToString() : ""));
...
void MasternodeList::updateNodeList()
{
    ...
    for (const auto& mnpair : mapMasternodes)
    {
        ...
        QTableWidgetItem *pubkeyItem = new QTableWidgetItem(QString::fromStdString(CCommerciumAddress(mn.pubKeyCollateralAddress.GetID()).ToString()));
...
void MasternodeList::ShowQRCode(std::string strAlias) {
    ...
    if (fFound) {
        ...
        strHTML += "<b>" + tr("Payee") +        ": </b>" + GUIUtil::HtmlEscape(CCommerciumAddress(mn.pubKeyCollateralAddress.GetID()).ToString()) + "<br>";
