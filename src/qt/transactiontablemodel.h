...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, CommerciumUnits::SeparatorStyle separators=CommerciumUnits::separatorStandard) const;
