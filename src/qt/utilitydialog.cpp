    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  commercium-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        if (showDebug) {
            strUsage += HelpMessageOpt("-uiplatform", strprintf("Select platform to customize UI for (one of windows, macosx, other; default: %s)", CommerciumGUI::DEFAULT_UIPLATFORM));
        }
...
All the Commercium in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 COMMERCIUM, 0.1 COMMERCIUM, 1 COMMERCIUM and 10 COMMERCIUM -- sort of like the paper money you use every day.</li> \
