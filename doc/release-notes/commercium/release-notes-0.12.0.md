...
Commercium version 0.12.0 is now available from:
...
backwards-compatible with pre-0.12 versions of Commercium or other software:
...
Switched to Bitcoin Core version 0.10 - https://commercium.net/en/release/v0.10.0
