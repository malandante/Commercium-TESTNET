...
class WalletTest (CommerciumTestFramework):
    ...
    def run_test (self):
        ...
        # Send 210 COMMERCIUM from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 1000 COMMERCIUM in block rewards plus fees, but
        ...
        # Send 100 COMMERCIUM with subtract fee from amount
        ...
        # Sendmany 100 COMMERCIUM with subtract fee from amount
