...
class RawTransactionsTest(CommerciumTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid commercium address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid commercium address" in e.error['message'])
        ...
        # send 12 COMMERCIUM to msig addr
